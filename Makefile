PROJECT_NAME := Pulumi apolloconfig Resource Provider

PACK             := apolloconfig
PACKDIR          := sdk
PROJECT          := github.com/tangr/pulumi-apolloconfig-native
NODE_MODULE_NAME := @tangr/apolloconfig
NUGET_PKG_NAME   := tangr.apolloconfig
