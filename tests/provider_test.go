...
import (
	...
	apolloconfig "github.com/tangr/pulumi-apolloconfig-native/provider"
)
...
func provider() integration.Server {
	return integration.NewServer(apolloconfig.Name, semver.MustParse("1.0.0"), apolloconfig.Provider())
}
