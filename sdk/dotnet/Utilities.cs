...
namespace Pulumi.Apolloconfig
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Apolloconfig.version.txt");
    ...
    internal sealed class ApolloconfigResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public ApolloconfigResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
